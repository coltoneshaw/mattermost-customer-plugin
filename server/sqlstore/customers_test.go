...
func TestGetCustomerByID(t *testing.T) {
	...
	t.Run("get customer id", func(t *testing.T) {
		_, err := db.Exec(`INSERT INTO crm_customers (id, name, licenseType, lastUpdated) VALUES ($1, $2, $3, $4)`, "1", "test", "cloud", 0)
		if err != nil {
			t.Fatal(err)
		}
...
func TestGetCustomerID(t *testing.T) {
	...
	t.Run("returns existing profile", func(t *testing.T) {
		_, err := db.Exec(`INSERT INTO crm_customers (id, name, LicenseType, siteurl, licensedto, lastupdated) VALUES ($1, $2, $3, $4, $5, $6)`, "1", "test", "cloud", "www.1.com", "1", 0)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("creates new due to too many exact matches", func(t *testing.T) {
		_, err := db.Exec(`INSERT INTO crm_customers (id, name, LicenseType, siteurl, licensedto, lastupdated) VALUES ($1, $2, $3, $4, $5, $6)`, "2", "test", "cloud", "www.1.com", "1", 0)
		if err != nil {
			t.Fatal(err)
		}
